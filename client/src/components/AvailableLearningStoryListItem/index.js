...
const AvailableLearningStoryListItem = ({
  availableLearningStories,
  handleViewStory,
  ...
  return (
    <Container className={classes.root}>
      {availableLearningStories.map(ls => renderLearningStory(ls, classes))}
    </Container>
  );
      ...
      <Accordion key={ls._id} defaultExpanded>
        ...
        <AccordionActions>
          ...
          <Button
            ...
            variant="contained"
            color="secondary"
            onClick={() => handleSubscribeStory(ls._id)}
          >
            SUBSCRIBE
          </Button>
        </AccordionActions>
...
AvailableLearningStoryListItem.propTypes = {
  availableLearningStories: PropTypes.array.isRequired,
  handleViewStory: PropTypes.func.isRequired,
  handleSubscribeStory: PropTypes.func.isRequired,
  reduceText: PropTypes.bool
};
export default AvailableLearningStoryListItem;
